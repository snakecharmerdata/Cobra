...
class FunctionPill:
    ...
    def __init__(self, canvas, x, y, name, function_id=None, list_id=None, list_order=None):
        self.canvas = canvas
        self.name = name
...
class DatabaseManager:
    ...
    def create_tables(self):
        ...
        try:
            cursor.execute("ALTER TABLE projects ADD COLUMN IF NOT EXISTS mapping_image BYTEA")
            cursor.execute("ALTER TABLE projects ADD COLUMN IF NOT EXISTS mapping_image_w INTEGER")
            cursor.execute("ALTER TABLE projects ADD COLUMN IF NOT EXISTS mapping_image_h INTEGER")
            cursor.execute("ALTER TABLE projects ADD COLUMN IF NOT EXISTS mapping_layout TEXT")
            cursor.execute("ALTER TABLE projects ADD COLUMN IF NOT EXISTS mapping_updated_at TIMESTAMP")
        except Exception:
